...
10. diagnostics_performed — ВСЕ обследования без исключения: биопсия, гистология, ИГХ (иммуногистохимия), ПЦР, КТ, МРТ, ПЭТ-КТ, УЗИ, рентген, ФГДС, колоноскопия, анализы крови, онкомаркеры, эндоскопия и другие. Каждое — отдельный объект {name: "КОНКРЕТНОЕ название обследования — ЗАПРЕЩЕНО оставлять пустым или писать 'Другое'", date: "дата или ''", result: "результат дословно или ''"}.
ВАЖНО: поле name ОБЯЗАТЕЛЬНО должно содержать конкретное название (например "ФГДС", "Биопсия", "Гистологическое исследование", "КТ органов грудной клетки"). Пустое name или "Другое" — ЗАПРЕЩЕНО.
